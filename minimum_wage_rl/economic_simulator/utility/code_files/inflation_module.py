...
#     new_product_price = (money_circulation * velocity_of_money)/country.quantity if money_circulation > 0 else current_product_price
...
#             # increase quantity
#             new_quantity = ceil((money_circulation * velocity_of_money)/current_product_price) if money_circulation > 0 else current_quantity
#             delta_quantity = new_quantity - current_quantity
#             increase_quantity(money_circulation,velocity_of_money,delta_quantity, new_quantity, current_quantity, country, metrics, current_product_price)
...
#                 new_product_price = (money_circulation * velocity_of_money)/new_quantity  if money_circulation > 0 else current_product_price        
